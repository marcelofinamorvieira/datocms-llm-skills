...
The generated migration captures schema diffs only; records and uploads are not
part of this flow.
...
7. Treat the generated migration as schema-only output, not as a records or
   uploads importer
...
2. Use the helper for sandbox-vs-primary or explicit environment-pair diffs
   when they want a schema-only migration

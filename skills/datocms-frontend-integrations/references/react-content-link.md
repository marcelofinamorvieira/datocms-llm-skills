...
React component that enables Visual Editing — click-to-edit overlays connecting website elements to DatoCMS fields. Content editors can click directly on content in the preview to edit it in the DatoCMS interface.
...
Place it in your root layout or provider (renders no visible UI):

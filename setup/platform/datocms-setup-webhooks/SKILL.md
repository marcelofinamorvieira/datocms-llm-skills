---
name: datocms-setup-webhooks
description: >-
  Set up DatoCMS webhook management with declarative webhook definitions, a
  sync helper, shared secret env placeholders, and an optional framework-native
  receiver endpoint for Next.js App Router, Nuxt, SvelteKit, or Astro.
...
This skill adds a declarative webhook config, a sync helper, and, when the repo
...
and `datocms-frontend-integrations`. Ensure both companion skills are installed
...
- `assets/datocms-sync-webhooks.mjs`

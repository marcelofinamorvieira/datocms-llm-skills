...
2. **Prerequisite: Draft mode** — Check if the draft mode enable endpoint exists:
   ...
   **If draft mode does not exist, STOP immediately and tell the user:**
   > "Draft mode must be set up before configuring Web Previews. Run `datocms-setup-draft-mode` first."
...
**Always load:**
- `../../../skills/datocms-frontend-integrations/references/web-previews-concepts.md`

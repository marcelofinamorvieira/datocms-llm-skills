...
2. **Prerequisite: Draft mode** — Check if the draft mode enable endpoint exists:
   ...
   **If draft mode does not exist, STOP immediately and tell the user:**
   > "Draft mode must be set up before configuring real-time updates. Run `datocms-setup-draft-mode` first."
...
- If draft mode does not exist, stop and tell the user to run `datocms-setup-draft-mode` first.
...
**Always load:**
- `../../../skills/datocms-frontend-integrations/references/realtime-concepts.md`
...
|---|---|
| Next.js (React) | `../../../skills/datocms-frontend-integrations/references/react-realtime.md` |
| Nuxt (Vue) | `../../../skills/datocms-frontend-integrations/references/vue-realtime.md` |
| SvelteKit | `../../../skills/datocms-frontend-integrations/references/svelte-realtime.md` |
| Astro | `../../../skills/datocms-frontend-integrations/references/astro-realtime.md` |

---
name: datocms-setup-site-search
description: >-
  Set up DatoCMS Site Search with search-index automation, least-privilege
  access token scaffolding, and a framework-appropriate search route for
  Next.js, Nuxt, SvelteKit, and Astro. Uses react-datocms or vue-datocms where
  available and falls back to the low-level Search API for other stacks.
disable-model-invocation: true
---

# DatoCMS Site Search Setup

You are an expert at setting up DatoCMS Site Search. This skill combines Dato
...
`datocms-frontend-integrations` and `datocms-cma`. Ensure those companion
...
- `../../../skills/datocms-frontend-integrations/references/site-search-api.md`
...
| Stack | Reference |
|---|---|
| React / Next.js | `../../../skills/datocms-frontend-integrations/references/react-site-search.md` |
| Vue / Nuxt | `../../../skills/datocms-frontend-integrations/references/vue-site-search.md` |
| SvelteKit / Astro / unsupported UI stack | `../../../skills/datocms-frontend-integrations/references/site-search-api.md` |

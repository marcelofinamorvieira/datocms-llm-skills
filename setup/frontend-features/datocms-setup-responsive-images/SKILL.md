---
name: datocms-setup-responsive-images
description: >-
  Set up reusable DatoCMS responsive-image rendering with framework-specific
  image components, shared wrappers, and safe query-shape defaults for
  Next.js, Nuxt, SvelteKit, and Astro. Falls back to creating the same thin CDA
  query baseline used by the setup bundle when the project lacks one.
...
projects. This skill creates or patches one shared Dato image wrapper,
...
| Framework | Reference |
|---|---|
| Next.js / React | `../../../skills/datocms-frontend-integrations/references/react-image.md` |
| Nuxt / Vue | `../../../skills/datocms-frontend-integrations/references/vue-image.md` |
| SvelteKit | `../../../skills/datocms-frontend-integrations/references/svelte-image.md` |
| Astro | `../../../skills/datocms-frontend-integrations/references/astro-image.md` |

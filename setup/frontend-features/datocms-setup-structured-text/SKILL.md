---
name: datocms-setup-structured-text
description: >-
  Set up reusable DatoCMS Structured Text rendering with framework-specific
  renderers, full value-links-blocks-inlineBlocks query shapes, and optional
  Content Link boundaries for Next.js, Nuxt, SvelteKit, and Astro. Falls back
  to creating the same thin CDA query baseline used by the setup bundle when
  the project lacks one.
...
projects. This skill creates one shared `DatoStructuredText` renderer, patches
...
- `../../../skills/datocms-cda/references/structured-text.md`

Then load the matching framework reference:

| Framework | Reference |
|---|---|
| Next.js / React | `../../../skills/datocms-frontend-integrations/references/react-structured-text.md` |
| Nuxt / Vue | `../../../skills/datocms-frontend-integrations/references/vue-structured-text.md` |
| SvelteKit | `../../../skills/datocms-frontend-integrations/references/svelte-structured-text.md` |
| Astro | `../../../skills/datocms-frontend-integrations/references/astro-structured-text.md` |
...
| Astro | `../../../skills/datocms-frontend-integrations/references/astro-content-link.md` |

---
name: datocms-setup-migration-release-workflow
description: >-
  Set up a safe DatoCMS CLI migration release workflow with maintenance mode,
  fork-and-run, promotion, a reusable local helper script, and optional GitHub
  Actions scaffolding. Use when users explicitly want to operationalize CLI
  migrations after basic CLI setup already exists.
...
repeatable production release workflow. This skill adds one local helper and,
